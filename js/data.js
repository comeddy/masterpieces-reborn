...
export const WORKS = [
  ...
  },
  {
    ...
    note: "보티첼리의 비너스가 바다 거품으로 빚어진다. 서풍의 신이 그랬듯 당신의 드래그가 바람이 되어 여신의 머리칼과 옷자락을 흩날리고, 장미 꽃잎이 화면을 가로지른다. 바람이 멎으면 거품은 다시 여신의 형상으로 피어오른다. 카메라 앞에서 펼친 손이 서풍이 되어 거품을 흩날리고, 주먹을 쥐었다 펼치면 돌풍이 몰아치며, 손이 빠르게 지나간 자리에는 장미 꽃잎이 날린다.",
