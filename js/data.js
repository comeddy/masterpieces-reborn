...
export const WORKS = [
  ...
  // ---- Ⅳ관 · 한국의 방 — 조선 회화, 신규 기법 ----
  {
    ...
    note: "비 갠 인왕산의 물기 어린 공기가 되살아난다. 안개가 산허리를 감싸며 흘렀다 걷히기를 반복하고, 화면을 누르면 먹 한 방울이 화선지에 스며 번져나간다. 진경산수의 바위 절벽은 먹빛이 깊을수록 단단해진다 — 겸재가 그린 비 갠 아침 그대로. 마이크에 숨을 불면 비 갠 산의 안개가 걷히고 조용해지면 다시 차오르며, 박수 소리에 먹 한 방울이 떨어진다.",
    hint: "🎤를 켜고 숨을 불면 산허리 안개가 걷힙니다 · 박수를 치면 먹 한 방울 · 마우스는 드래그로 안개, 누르면 먹",
    mic: true,
  ...
  },
  {
    ...
    hint: "🎤를 켜고 환호하세요 — 소리가 클수록 관중이 들썩입니다 · 외치거나 박수 치면 기술 · 마우스는 클릭으로 기술, 드래그로 파도응원",
    mic: true,
  ...
  },
  {
    ...
    note: "'달빛 침침한 삼경, 두 사람 마음은 두 사람만 안다(月沈沈夜三更 兩人心事兩人知).' 혜원이 화폭 한켠에 적어둔 그 밤이 흐른다. 초승달이 천천히 차고 기울며 밤의 깊이가 변하고, 당신의 커서가 구름이 되어 달을 가리면 — 초롱불 하나만 남은 어둠 속에서 밀회는 조금 더 깊어진다. 마이크에 바람 소리를 내면 구름이 달로 흘러가 밤이 깊어지고, 박수 소리에 초롱불이 깜빡인다.",
    hint: "🎤를 켜고 \"후—\" 바람 소리를 내면 구름이 달을 가립니다 · 박수를 치면 초롱불이 깜빡 · 마우스는 커서로 구름, 클릭으로 초롱불",
    mic: true,
